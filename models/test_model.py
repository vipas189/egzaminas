...
class Test(db.Model):
    ...
    )  # Nustatyta kaip True pagal nutylėjimą
    ...
    questions = db.relationship(
        "TestQuestion", backref="test", cascade="all, delete-orphan"
    )
    attempts = db.relationship(
        "TestAttempt", backref="test", cascade="all, delete-orphan"
    )
...
class TestQuestion(db.Model):
    ...
    options = db.relationship(
        "TestQuestionOption", backref="question", cascade="all, delete-orphan"
    )
...
class TestQuestionOption(db.Model):
    ...
    question_id = db.Column(
        db.Integer, db.ForeignKey("test_question.id"), nullable=False
    )
...
class TestAttempt(db.Model):
    ...
    answers = db.relationship(
        "TestAnswer", backref="attempt", cascade="all, delete-orphan"
    )
