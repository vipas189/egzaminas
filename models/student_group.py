...
class StudentGroup(db.Model):
    ...
    students = db.relationship(
        "Users", secondary="student_group_membership", backref="groups"
    )
...
student_group_membership = db.Table(
    "student_group_membership",
    db.Column("student_id", db.Integer, db.ForeignKey("users.id"), primary_key=True),
    db.Column(
        "group_id", db.Integer, db.ForeignKey("student_group.id"), primary_key=True
    ),
)
