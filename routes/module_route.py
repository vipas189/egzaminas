...
# Create new module
@module_bp.route('/modules/create', methods=['GET', 'POST'])
def create_module():
    form = ModuleForm()
    if form.validate_on_submit():
        ...
        return redirect(url_for('modules.view_module', id=module.id))
...
# Delete module
@module_bp.route('/modules/<int:id>/delete', methods=['POST'])
...
# Schedule management
@module_bp.route('/modules/<int:id>/schedules/add', methods=['GET', 'POST'])
def add_schedule(id):
    module = Module.query.get_or_404(id)
    form = ScheduleForm()
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('modules.view_module', id=id))
    
    return render_template('modules/add_schedule.html', form=form, module=module)

@module_bp.route('/modules/<int:module_id>/schedules/<int:schedule_id>/edit', methods=['GET', 'POST'])
def edit_schedule(module_id, schedule_id):
    ...
    if schedule.module_id != module_id:
        ...
        return redirect(url_for('modules.view_module', id=module_id))
...
@module_bp.route('/modules/<int:module_id>/schedules/<int:schedule_id>/delete', methods=['POST'])
...
@module_bp.route('/modules/<int:id>/assessments/add', methods=['GET', 'POST'])
...
@module_bp.route('/modules/<int:module_id>/assessments/<int:assessment_id>/edit', methods=['GET', 'POST'])
...
@module_bp.route('/modules/<int:module_id>/assessments/<int:assessment_id>/delete', methods=['POST'])
...
# Exam management
@module_bp.route('/modules/<int:id>/exams/add', methods=['GET', 'POST'])
def add_exam(id):
    module = Module.query.get_or_404(id)
    form = ExamForm()
...
@module_bp.route('/modules/<int:module_id>/exams/<int:exam_id>/edit', methods=['GET', 'POST'])
...
@module_bp.route('/modules/<int:module_id>/exams/<int:exam_id>/delete', methods=['POST'])
